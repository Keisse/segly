...
function describeNoteChange(oldValue: unknown, newValue: unknown) {
  ...
  return { title: "Notas atualizadas", detail: "Houve uma alteração no histórico de notas deste lead", meta: null };
}
